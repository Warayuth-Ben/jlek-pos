...
public sealed class PrintCustomerReceiptCommandHandler
{
    ...
    public PrintCustomerReceiptCommandHandler(
    ...
    public async Task<PrintResult> Handle(
        PrintCustomerReceiptCommand command,
        CancellationToken cancellationToken = default)
    {
        var startedAt = _clock.UtcNow;

        var data = await _dataProvider.GetCustomerReceiptDataAsync(
        ...
        var document = _formatter.FormatCustomerReceipt(data, command.IsReprint);
